...
// IsAutoGeneratedBundleName returns true if the bundle name is auto generated
func IsAutoGeneratedBundleName(bundleName string) bool {
	return strings.HasPrefix(bundleName, BundleNamePrefix)
}
